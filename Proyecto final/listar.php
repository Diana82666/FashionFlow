...
<body>
    ...
    <button type="submit"><a href="index.php">Volver a la web</a></button>
    <h2>Lista de ropa</h2>
    <p>La siguiente lista muestra los datos de la ropa actualmente en stock.</p>
    <br>
    <a href="nike.php">Ver productos Nike</a>
    <span>&nbsp;&nbsp;</span> <!--espacio en blanco-->
    <a href="adidas.php">Ver productos Adidas</a>
    <span>&nbsp;&nbsp;</span> <!--espacio en blanco-->
    <a href="supreme.php">Ver Productos Supreme</a>
    <span>&nbsp;&nbsp;</span> <!--espacio en blanco-->
    <a href="buzos.php">Ver buzos</a>
    <span>&nbsp;&nbsp;</span> <!-- otro espacio en blanco-->
    <a href="remeras.php">Ver remeras</a>
    <span>&nbsp;&nbsp;</span> <!--espacio en blanco-->
    <a href="precio.php">Ver precios mayores a $500</a>
    <span>&nbsp;&nbsp;</span> <!--espacio en blanco-->
    <a href="preciomenor.php">Ver precios menores a $500</a>
    <span>&nbsp;&nbsp;</span> <!--espacio en blanco-->
